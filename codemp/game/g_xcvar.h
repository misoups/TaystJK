...
XCVAR_DEF( g_autoSpec,					"0",			NULL,				CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( g_crossServerPorts,			"",				NULL,				CVAR_ARCHIVE,									qfalse ) // space/comma-separated list of OTHER server ports for /say_cross
XCVAR_DEF( g_mapHaste,					"0",			NULL,				CVAR_NONE,										qfalse ) // per-map CPM/OCPM haste mode (set via mapconfigs/<mapname>.cfg)
...
XCVAR_DEF( g_noStartReactivate,			"1",			NULL,				CVAR_ARCHIVE,									qtrue )
